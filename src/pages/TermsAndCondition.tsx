          ...
          <article className="prose prose-slate max-w-none space-y-6">
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-700 leading-relaxed list-disc list-outside pl-6">
                <li>Nomadic Plan is a travel-based platform that provides destination information, travel inspiration, and booking assistance for tours, stays, and experiences.</li>
                <li>Some services may be offered directly by Nomadic Plan, while others are facilitated through verified third-party providers ("Vendors").</li>
                <li>These Terms apply to all visitors, users, and registered members of Nomadic Plan.</li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3 text-slate-700">
                <div>
                  ...
                  <p className="leading-relaxed">All bookings made through Nomadic Plan are subject to availability and confirmation. You will receive an email confirmation once a booking is successfully processed by the Vendor.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">Nomadic Plan reserves the right to refuse or cancel any booking at its discretion if fraud, payment issues, or misuse is suspected, or if the transaction violates applicable laws or our internal risk policies.</p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3 text-slate-700">
                <ul className="space-y-2 list-disc list-outside pl-6">
                  ...
                  <li>Nomadic Plan may charge a non-refundable service or convenience fee.</li>
                ...
                <div className="mt-4">
                  ...
                  <ul className="space-y-2 list-disc list-outside pl-6">
                    <li>Nomadic Plan functions as a travel platform and intermediary between travelers and verified third-party service providers (such as hotels, tour operators, and transport partners).</li>
                    <li>Each service provider has its own cancellation, amendment, and refund rules, which are binding on the user once a booking is confirmed. This policy applies to all bookings made directly through our Website or via official Nomadic Plan representatives.</li>
                  </ul>
                </div>
                ...
                <div className="mt-4">
                  <h3 className="font-semibold mb-2">4.3. Cancellations by Nomadic Plan or Vendor</h3>
                  <p className="leading-relaxed mb-2">Nomadic Plan or the Vendor reserves the right to cancel a booking in cases of:</p>
                  <ul className="space-y-2 list-disc list-outside pl-6">
                  ...
                  <p className="leading-relaxed mt-3">Nomadic Plan will not be responsible for any indirect losses (such as flight costs, visa fees, or other expenses) arising from cancellations beyond our control.</p>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <ul className="space-y-2 list-disc list-outside pl-6">
                    ...
                    <li>Nomadic Plan will provide you with email confirmation once the refund has been initiated.</li>
                  </ul>
                </div>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-700 leading-relaxed list-disc list-outside pl-6">
                ...
                <li>Nomadic Plan reserves the right to suspend or terminate accounts found violating these Terms or engaging in misuse.</li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-700 leading-relaxed list-disc list-outside pl-6">
                ...
                <li>Nomadic Plan is not responsible for losses caused by denied travel or entry due to missing or invalid documents.</li>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-700 leading-relaxed list-disc list-outside pl-6">
                <li>Nomadic Plan may include links, offers, or bookings from third-party providers such as airlines, hotels, and tour operators.</li>
                ...
                <li>Any issues, delays, or service failures should be reported directly to the Vendor. Nomadic Plan will provide assistance but does not assume liability.</li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                Nomadic Plan does not provide or sell insurance products directly.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 text-slate-700 leading-relaxed list-disc list-outside pl-6">
                <li>All content on this Website including text, images, graphics, videos, logos, and software is the exclusive property of Nomadic Plan or its content partners and is protected under applicable copyright and trademark laws.</li>
                <li>You may not reproduce, distribute, modify, or republish any content without prior written consent from Nomadic Plan.</li>
                <li>Unauthorized use of our intellectual property may result in legal action.</li>
                <li>User-generated content (such as reviews, images, or stories) submitted to the platform grants Nomadic Plan a non-exclusive, royalty-free license to use such content for promotional or editorial purposes.</li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3 text-slate-700">
                <div>
                  ...
                  <p className="leading-relaxed">Nomadic Plan strives to provide accurate information but does not guarantee the completeness, accuracy, or reliability of all content.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed mb-2">By participating in any travel experience or using the services listed on Nomadic Plan, you acknowledge and accept these risks.</p>
                  <p className="leading-relaxed mb-2">Nomadic Plan is not responsible for any injury, illness, loss of property, or anything that may occur during travel, tours, or activities arranged through third-party providers.</p>
                  ...
                  <p className="leading-relaxed">Nomadic Plan strives to ensure accuracy of content but does not warrant that descriptions, photos, or information on the Website are free of errors or omissions.</p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-slate-700 leading-relaxed">
                Nomadic Plan and its partners shall not be liable for any delay or failure to perform obligations due to causes beyond reasonable control — including, but not limited to, natural disasters, war, pandemics, political unrest, or governmental actions.
            ...
            <section className="space-y-4">
              ...
              <p className="text-slate-700 leading-relaxed mb-2">You agree to indemnify and hold harmless Nomadic Plan, its founders, employees, and affiliates from any claims, damages, liabilities, or expenses (including legal fees) arising from your:</p>
            ...
            <section className="space-y-4">
              ...
              <p className="text-slate-700 leading-relaxed">
                These Terms and Conditions, along with our Privacy Policy and Cancellation & Refund Policy, constitute the entire agreement between you and Nomadic Plan with respect to the Website and Services, superseding all prior communications, understandings, or agreements (whether oral or written).
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <div className="text-slate-700 leading-relaxed space-y-2">
                ...
                <p>🌐 Website: <a href="https://www.nomadicplan.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 hover:underline transition-colors">https://www.nomadicplan.com</a></p>
            ...
            <section className="space-y-4 pt-8 border-t border-slate-200">
              ...
              <p className="text-slate-700 leading-relaxed mb-2">
                All travel experiences, photos, and reviews featured on Nomadic Plan are for informational and inspirational purposes only.
                Actual experiences may vary due to weather conditions, local regulations, or third-party operations.
                Nomadic Plan does not guarantee any specific outcome, availability, or satisfaction level for services provided by third parties.
              </p>
            </section>
          </article>
        </div>
